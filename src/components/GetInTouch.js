      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div className="col-span-2 lg:col-span-1 mt-6 lg:mt-0">
          ...
          <div className='mt-5 flex justify-center md:justify-start gap-5 p-4'>
            <Link href="https://www.github.com/BimaBizz" target="_blank" rel="noreferrer" className='flex items-center justify-center bg-[#1c1d2c] rounded-full p-4 border border-indigo-500 w-fit' data-aos="flip-left" data-aos-duration="1500">
            ...
            <Link href="https://www.instagram.com/akuubimaa_" target="_blank" rel="noreferrer" className='flex items-center justify-center bg-[#1c1d2c] rounded-full p-4 border border-indigo-500 w-fit' data-aos="flip-left" data-aos-duration="1700">
              <svg className="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path fill="currentColor" fillRule="evenodd" d="M3 8a5 5 0 0 1 5-5h8a5 5 0 0 1 5 5v8a5 5 0 0 1-5 5H8a5 5 0 0 1-5-5V8Zm5-3a3 3 0 0 0-3 3v8a3 3 0 0 0 3 3h8a3 3 0 0 0 3-3V8a3 3 0 0 0-3-3H8Zm7.597 2.214a1 1 0 0 1 1-1h.01a1 1 0 1 1 0 2h-.01a1 1 0 0 1-1-1ZM12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6Zm-5 3a5 5 0 1 1 10 0 5 5 0 0 1-10 0Z" clipRule="evenodd"/>
              </svg>
            </Link>
            <Link href="https://www.linkedin.com/in/bimabizz/" target="_blank" rel="noreferrer" className='flex items-center justify-center bg-[#1c1d2c] rounded-full p-4 border border-indigo-500 w-fit' data-aos="flip-left" data-aos-duration="1900">
              <svg className="w-6 h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
