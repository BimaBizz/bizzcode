...
export default function Hero(props) {
    ...
    return (
        ...
        <div className={"max-w-3xl"}>
          ...
          <p className="font-semibold" data-aos="fade-up" data-aos-duration="1500">See my work at <Link href={"/projects"} className="text-white md:text-indigo-500 underline underline-offset-4">this page</Link></p>
        </div>
      </section>
    )
}