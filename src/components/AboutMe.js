...
const AboutMe = (props) => {
  ...
  return (
    <>
      ...
      <section className='relative flex w-full justify-center items-center max-w-5xl mx-auto p-4 min-h-screen'>
        <div className='max-w-3xl xm-auto w-full'>
      ...
      {showForm && <MessageForm onSubmit={handleFormSubmit} />} {/* Render form when showForm is true */}
    </>
  )
}
