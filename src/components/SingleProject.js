    ...
    <section className='relative'>
        <div className='flex flex-col md:flex-row w-full max-w-5xl justify-center items-center mx-auto p-4 gap-10'>
            ...
            <div className='self-start w-full lg:w-1/2'>
                <h1 className={'text-3xl font-bold md:text-6xl mb-4'+props.class} data-aos="fade-right" data-aos-duration="1500">{project.name}</h1>
        ...
        <div className='w-full max-w-5xl mx-auto p-4'>
            ...
            <div dangerouslySetInnerHTML={{__html: project.deskripsi}} className='text-wrap text-slate-300 text-justify text-lg' data-aos="fade-up" data-aos-duration="1500"></div>
        </div>
    </section>
  )
}
