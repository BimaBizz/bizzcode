...
const Contact = () => {
  ...
  return (
    <section className='relative flex flex-col lg:flex-row w-full max-w-5xl mx-auto p-4 justify-center items-center min-h-screen'>
      ...
      <form onSubmit={handleSubmit} encType="multipart/form-data" acceptCharset="UTF-8" className='grid md:grid-cols-2 gap-4 w-full max-w-3xl mt-10 text-slate-800' data-aos="fade-left" data-aos-duration="1500">
        <div className='flex flex-col space-y-1 col-span-2 md:col-span-1'>
          ...
          <input className='border border-gray-400 rounded-lg p-3' type="text" placeholder='Enter your name' 
            value={formData.name}
        ...
        <div className='flex flex-col space-y-1 col-span-2 md:col-span-1'>
          ...
          <input className='border border-gray-400 rounded-lg p-3' type="email" placeholder='Enter your email' 
        ...
        <div className='col-span-2 flex flex-col space-y-1'>
          ...
          <textarea className='border border-gray-400 rounded-lg p-3' rows="5" type="text" placeholder='Enter your message' 
