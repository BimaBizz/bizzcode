...
export default function SearchBar({ initialSearch }) {
  ...
  return (
    <div className='mx-auto max-w-5xl p-4 relative'>
      <form onSubmit={handleSubmit} className="border text-[#1c1d2c] my-7 border-gray-300 rounded-md p-4 w-full flex items-center bg-white"
