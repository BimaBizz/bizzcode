                ...
                {data.map((certificate, index) => (
                    <div key={index} data-aos="fade-up" data-aos-duration={1500} className='flex flex-col space-y-3'>
                        <div className='object-cover object-center h-[350px] rounded-xl overflow-hidden relative group'>
                            ...
                            <div className='text-lg font-bold w-full bg-gradient-to-b from-transparent to-black/80 text-white z-10 translate-y-0 p-4 h-1/2 absolute group-hover:-translate-y-[100%] group-hover:transition-all group-hover:duration-500'><h1 className='absolute bottom-2'>{certificate.name}</h1></div>
                        </div>
                        <table>
                            <tbody>
                                <tr>
