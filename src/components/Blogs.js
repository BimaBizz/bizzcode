...
const Blogs = (props) => {
  ...
  return (
    ...
    <section className='relative max-w-5xl mx-auto p-4 min-h-[50vh] flex items-center justify-center'>                  
    {data && data.length > 0 ? (
            ...
            <h1 className='text-center text-3xl font-bold mt-10' data-aos="fade-right" data-aos-duration="1500">Not Found</h1>
    )}
    </section>
