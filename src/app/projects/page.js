...
export const metadata = {
  title: 'My Works',
  description: 'Telusuri berbagai proyek kreatif dan inovatif Bima Mahendra sebagai Frontend Web Developer di Bizzcode. Dapatkan wawasan mendalam tentang bagaimana saya menggunakan JavaScript, React, HTML, dan CSS untuk menciptakan pengalaman web yang menakjubkan dan responsif.',
  alternates: {
    canonical: '/projects',
  },
  openGraph: {
    url: 'https://bizzcode.site/projects',
    ...
    return (
      <main className="relative overflow-hidden">
        ...
        <HeaderPages class={JostFont.className} title="My Work" subtitle="Some of the works are from my homework and some are on my own time.">
          <p className="font-semibold mt-14" data-aos="fade-up" data-aos-duration="1500">Come and see my <Link href={"https://github.com/BimaBizz"} target="_blank" className="text-indigo-500 underline underline-offset-4">Github</Link></p>
        </HeaderPages>
