...
export default async function Page({ searchParams }) {
  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <Navbar />
      <HeaderPages className={JostFont.className} title="Blog" subtitle="On this blog I share tips and tricks, frameworks, projects, tutorials, etc.">
      </HeaderPages>
